export const endpoints = {
  ...
  institutionOwnership: 'api/v1/enums/institutionOwnership',
  numberOfPublications: 'api/v1/enums/numberOfPublications',
  academicsYearOfExperience: 'api/v1/enums/academicsYearOfExperience',
  academicsHighestLevelOfEducation:
    'api/v1/enums/academicsHighestLevelOfEducation',
  educationSponsor: 'api/v1/enums/educationFunding',
  clergyFaith: 'api/v1/enums/clergyFaith',
  clergyMembershipCount: 'api/v1/enums/clergyMembershipCount',
  securityOutfitType: 'api/v1/enums/securityOutfitType',
  securityDutyPost: 'api/v1/enums/securityDutyPost',
  ...
  scaleOfTrade: 'api/v1/enums/scaleOfTrade',
  timeInBusiness: 'api/v1/enums/timeInBusiness',
  InterventionTypes: 'api/v1/enums/governmentInterventionTypes',
  InterventionLevel: 'api/v1/enums/interventionImpactLevel',
